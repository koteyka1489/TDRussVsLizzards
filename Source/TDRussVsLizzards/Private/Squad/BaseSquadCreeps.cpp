...
void ABaseSquadCreeps::UpdateSquadPostionKeys(const TMap<int32, FVector>& NewPositions)
{
    ...
    {
        if (!NewPositions.Contains(CreepPair.Key))
        {
...
{
    UpdateSquadPostionKeys(SquadCalcTargetComponent->GetNewCreepsLocations());
